      ...
      <div className="row p-5 mt-5 border-top text-muted fs-6">
        <div className="col-6 p-5">
          <p>
            ...
            Zerodha, a combination of Zero and "Rocha", the Sanskrit word for
            barrier.
          </p>
          <p>
          ...
          <p>
            Over 1+ Gum aig (ES SIE Of Bs Gi) Cp Serhan powerful ecbsysten of
        ...
        <div className="col-6 p-5">
          <p>
            ...
            community initiatives to empovier retail traders and investors.
          </p>
          <p>
            {" "}
